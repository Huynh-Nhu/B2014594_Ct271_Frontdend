<template>
  <headerVue></headerVue>
  <div class="img-connect row align-items-center">
    <div class="col-sm-9">
      <h1>Liên hệ</h1>
      <h3>Vui lòng điền vào biểu mẫu để gửi phản hồi của bạn tới BoBamBu</h3>
    </div>
    <div class="col-sm-3">
  ...
  <p class="text-connect">
    BoBamBu luôn mong muốn nhận được nhưng phản hồi quý giá của quý khách hàng để có cơ hội hoàn
