    ...
    <div class="row  form-update">
      <div class="form-content-update col-md-6 offset-md-3">
        ...
        <div class="col-md-6 offset-md-3 ">
          <form @submit.prevent="updateProduct" enctype="multipart/form-data" class="form-update-children">
            <div>
              <label  for="name">Tên sản phẩm:</label>
              <input class="form-control mt-3" type="text" id="name" v-model="products.name" required />
            </div>
            ...
            <div>
              ...
              <textarea class="form-control  mt-3" id="details" v-model="products.details"></textarea>
            </div>
...
.form-update::before{
  content: "";
    ...
    width: 100%;
    height: 100%;
    background: url('/img/png/nen3.jpg') center;
    filter: blur(1.5px); /* Điều chỉnh mức độ mờ tại đây */
    z-index: -1;
}
.form-content-update{
